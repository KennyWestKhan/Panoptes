  ...
  <v-container fluid class="" transition="dialog-bottom-transition">
    <v-row>
      <v-col cols="12" sm="6" md="6">
          ...
          <tinymce id="extractedTextDiv" v-show="previewText == false"  v-model="text" :other_options="options" name="extractedTextDiv"></tinymce>
      </v-col>
      <v-col cols="12" sm="6" md="6">
        <v-card
          class="pa-2"
